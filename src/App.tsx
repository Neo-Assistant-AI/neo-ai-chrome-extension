  ...
  return (
    <div className="flex flex-col rounded-lg mx-auto w-screen bg-white h-screen">
      <div className="flex items-center justify-start w-full text-black bg-[#f1f3f5] border-b-[1px] border-b-[#ced4da] tracking-tighter p-6">
        ...
        <div className="text-xl font-black">Neo Assistant</div>
      </div>
      <div ref={ref} className="h-full overflow-y-scroll flex flex-col text-base items-center px-8 pt-4 pb-20">
        ...
        <input
          type="text"
          ref={inputRef}
          className="block w-[100%] my-2 mb-6 border-[1px] rounded-lg outline-none text-base text-black p-3 bg-white bg-left-center bg-no-repeat bg-3.5% focus:border-[1px] focus:border-green-400"
          placeholder="Ask me anything about Neo Chain"
          disabled={loading}
          value={prompt}
